    ...
    async.waterfall([
        function (callback) {
            listQueue(sqs, function (err, data) {
                ...
                callback(null, "https://sqs.ap-southeast-1.amazonaws.com/613477150601/game-demo-deadletter.fifo")
            })
        },
        function (queueUrl, callback) {
            if (queueUrl.endsWith(".fifo")) {
                ...
                sendDelayedMessage(sqs, queueUrl, "hello world", function (err, data) {
                    if (err) {
                        callback(err, null)
                    }
                    else {
